...
const IMAGES = Array.from({ length: 23 }, (_, i) => `/images/${i + 1}.png`);
                        ...
                        return (
                            ...
                            >
                                <Image 
                                    ...
                                    className="object-contain opacity-90 hover:opacity-100 transition-all duration-300 scale-[2.0] md:scale-[2.2] hover:scale-[2.2] md:hover:scale-[2.5] drop-shadow-[0_15px_15px_rgba(0,0,0,0.5)]"
                                />
                            </div>
                        );
                    })}
